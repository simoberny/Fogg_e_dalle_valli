                    ...
                    <div class="row">
                            ...
                            <ul class="collapsible" data-collapsible="expandable">
                                <li>
                                    ...
                                    <div class="collapsible-body white"> 
                                        ...
                                        <input type="hidden" class="unibox-price-max" name="max" value="<%= (request.getParameter("max") != null) ? request.getParameter("max") : 1000%>" />
                                    </div>
                                </li>
                                <li>
                        ...
                        <div class="col s12 m6 l8 xl9">
                            ...
                            <%
                                ...
                                List<Item> list = Item.cerca(txt, min, max, categoria, voto, venditore, ordinamento);
                            ...
                            <ul class="pagination center">
                                ...
                                <li class="active"><button href="#!" name="pag" value="1">1</button></li>
